...
// CriarDeploymentConfig criar
func CriarDeploymentConfig(namespace string, body io.Reader) (interface{}, int, error) {
	var interf interface{}

	endpoint := variaveis.OpenshiftUrl + variaveis.ApiApps + "namespaces/" + namespace + "/deploymentconfigs"
